...
for ii in range(len(f_list)):
    ...
    # file path
    file_path_residual_SVD="./SOPT_sample_points/ex16_AE_{}_swish_residual_SVD_seed_{}.p".format(f,seed) # change path
...
with open(file="./SOPT_sample_points/ex16_AE_inner_SOPT_no_oversampling.p",mode='wb') as fff:
    pickle.dump(msmt_idx_list_inner,fff)
with open(file="./SOPT_sample_points/ex16_AE_bndry_SOPT_no_oversampling.p",mode='wb') as ffff:
...
msmt_idx_list_inner=np.array(msmt_idx_list_inner)
msmt_idx_list_bndry=np.array(msmt_idx_list_bndry)
with open(file="./SOPT_sample_points/ex16_AE_inner_SOPT_oversampling.p",mode='wb') as fff:
    pickle.dump(msmt_idx_list_inner,fff)
with open(file="./SOPT_sample_points/ex16_AE_bndry_SOPT_oversampling.p",mode='wb') as ffff:
    pickle.dump(msmt_idx_list_bndry,ffff)