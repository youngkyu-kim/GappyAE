...
# file path
file_name_SVD="./model/ex16_SVD.p"
...
with open(file="./model/ex16_POD_inner_SOPT_no_oversampling.p",mode='wb') as fff:
    pickle.dump(msmt_idx_list_inner,fff)
with open(file="./model/ex16_POD_bndry_SOPT_no_oversampling.p",mode='wb') as ffff:
...
msmt_idx_list_inner=np.array(msmt_idx_list_inner)
msmt_idx_list_bndry=np.array(msmt_idx_list_bndry)
with open(file="./model/ex16_POD_inner_SOPT_oversampling.p",mode='wb') as fff:
    pickle.dump(msmt_idx_list_inner,fff)
with open(file="./model/ex16_POD_bndry_SOPT_oversampling.p",mode='wb') as ffff:
    pickle.dump(msmt_idx_list_bndry,ffff)